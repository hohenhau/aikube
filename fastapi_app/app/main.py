...
@app.post("/texts/analyse_and_add_text")
...
def retrieve_text_entry(text_id: int, db: Session = Depends(get_db)):
...
def retrieve_all_text_entries(db: Session = Depends(get_db)):
